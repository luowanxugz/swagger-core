...
public class OperationParser {
    ...
    public static Optional<RequestBody> getRequestBody(io.swagger.v3.oas.annotations.parameters.RequestBody requestBody, Annotation classConsumes, Annotation methodConsumes, Components components, JsonView jsonViewAnnotation, boolean openapi31) {
        ...
        AnnotationsUtils.getContent(requestBody.content(), classConsumes == null ? new String[0] : JaxRsAnnotationLoader.getAnnotationValues(classConsumes, "value"),
                methodConsumes == null ? new String[0] : JaxRsAnnotationLoader.getAnnotationValues(methodConsumes, "value"), null, components, jsonViewAnnotation, openapi31).ifPresent(requestBodyObject::setContent);
        return Optional.of(requestBodyObject);
    }
    ...
    public static Optional<ApiResponses> getApiResponses(final io.swagger.v3.oas.annotations.responses.ApiResponse[] responses, Annotation classProduces, Annotation methodProduces, Components components, JsonView jsonViewAnnotation, boolean openapi31, String defaultResponseKey) {
        ...
        for (io.swagger.v3.oas.annotations.responses.ApiResponse response : responses) {
            ...
            AnnotationsUtils.getContent(response.content(), classProduces == null ? new String[0] : JaxRsAnnotationLoader.getAnnotationValues(classProduces, "value"),
                    methodProduces == null ? new String[0] : JaxRsAnnotationLoader.getAnnotationValues(methodProduces, "value"), null, components, jsonViewAnnotation, openapi31).ifPresent(apiResponseObject::content);
